...
class TestAccountConnectionChallenges:
    ...
    def test_raw_response_submit(self, client: XTwitterScraper) -> None:
        ...
        account_connection_challenge = response.parse()
        assert_matches_type(AccountConnectionChallengeSubmitResponse, account_connection_challenge, path=["response"])
    ...
    def test_streaming_response_submit(self, client: XTwitterScraper) -> None:
        with client.x.account_connection_challenges.with_streaming_response.submit(
            ...
            account_connection_challenge = response.parse()
            assert_matches_type(
                AccountConnectionChallengeSubmitResponse, account_connection_challenge, path=["response"]
            )
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_path_params_submit(self, client: XTwitterScraper) -> None:
...
class TestAsyncAccountConnectionChallenges:
    ...
    async def test_raw_response_submit(self, async_client: AsyncXTwitterScraper) -> None:
        ...
        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        account_connection_challenge = await response.parse()
        assert_matches_type(AccountConnectionChallengeSubmitResponse, account_connection_challenge, path=["response"])
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_path_params_submit(self, async_client: AsyncXTwitterScraper) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
