...
from x_twitter_scraper import XTwitterScraper, AsyncXTwitterScraper, APIResponseValidationError
from x_twitter_scraper._types import Omit
from x_twitter_scraper._utils import asyncify
from x_twitter_scraper._models import BaseModel, FinalRequestOptions
from x_twitter_scraper._exceptions import APIStatusError, APITimeoutError, APIResponseValidationError
from x_twitter_scraper._base_client import (
    DEFAULT_TIMEOUT,
...
def _get_open_connections(client: XTwitterScraper | AsyncXTwitterScraper) -> int:
...
class TestXTwitterScraper:
    ...
    def test_raw_response(self, respx_mock: MockRouter, client: XTwitterScraper) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_raw_response_for_binary(self, respx_mock: MockRouter, client: XTwitterScraper) -> None:
    ...
    def test_copy(self, client: XTwitterScraper) -> None:
        copied = client.copy()
    ...
    def test_copy_signature(self, client: XTwitterScraper) -> None:
    ...
    def test_hardcoded_query_params_in_url(self, client: XTwitterScraper) -> None:
    ...
    def test_request_extra_headers(self, client: XTwitterScraper) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_request_extra_query(self, client: XTwitterScraper) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_multipart_repeating_array(self, client: XTwitterScraper) -> None:
        request = client._build_request(
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_binary_content_upload(self, respx_mock: MockRouter, client: XTwitterScraper) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_basic_union_response(self, respx_mock: MockRouter, client: XTwitterScraper) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_union_response_different_types(self, respx_mock: MockRouter, client: XTwitterScraper) -> None:
    ...
    def test_base_url_trailing_slash(self, client: XTwitterScraper) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: XTwitterScraper) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: XTwitterScraper) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_client_response_validation_error(self, respx_mock: MockRouter, client: XTwitterScraper) -> None:
        class Model(BaseModel):
            foo: str
    ...
    def test_parse_retry_after_header(
        self, remaining_retries: int, retry_after: str, timeout: float, client: XTwitterScraper
    ) -> None:
    ...
    def test_omit_retry_count_header(
        self, client: XTwitterScraper, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_follow_redirects(self, respx_mock: MockRouter, client: XTwitterScraper) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_follow_redirects_disabled(self, respx_mock: MockRouter, client: XTwitterScraper) -> None:
...
class TestAsyncXTwitterScraper:
    @pytest.mark.respx(base_url=base_url)
    async def test_raw_response(self, respx_mock: MockRouter, async_client: AsyncXTwitterScraper) -> None:
        respx_mock.post("/foo").mock(return_value=httpx.Response(200, json={"foo": "bar"}))
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_raw_response_for_binary(self, respx_mock: MockRouter, async_client: AsyncXTwitterScraper) -> None:
        respx_mock.post("/foo").mock(
            return_value=httpx.Response(200, headers={"Content-Type": "application/binary"}, content='{"foo": "bar"}')
        )
    ...
    def test_copy(self, async_client: AsyncXTwitterScraper) -> None:
    ...
    def test_copy_signature(self, async_client: AsyncXTwitterScraper) -> None:
        # ensure the same parameters that can be passed to the client are defined in the `.copy()` method
        init_signature = inspect.signature(
            # mypy doesn't like that we access the `__init__` property.
    ...
    async def test_hardcoded_query_params_in_url(self, async_client: AsyncXTwitterScraper) -> None:
    ...
    def test_multipart_repeating_array(self, async_client: AsyncXTwitterScraper) -> None:
        request = async_client._build_request(
            FinalRequestOptions.construct(
                method="post",
                url="/foo",
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_binary_content_upload(self, respx_mock: MockRouter, async_client: AsyncXTwitterScraper) -> None:
        respx_mock.post("/upload").mock(side_effect=mirror_request_content)
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_basic_union_response(self, respx_mock: MockRouter, async_client: AsyncXTwitterScraper) -> None:
        class Model1(BaseModel):
            name: str
    ...
    async def test_base_url_trailing_slash(self, client: AsyncXTwitterScraper) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    async def test_base_url_no_trailing_slash(self, client: AsyncXTwitterScraper) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    async def test_absolute_request_url(self, client: AsyncXTwitterScraper) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_parse_retry_after_header(
        self, remaining_retries: int, retry_after: str, timeout: float, async_client: AsyncXTwitterScraper
    ) -> None:
        headers = httpx.Headers({"retry-after": retry_after})
        options = FinalRequestOptions(method="get", url="/foo", max_retries=3)
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncXTwitterScraper, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_follow_redirects(self, respx_mock: MockRouter, async_client: AsyncXTwitterScraper) -> None:
        # Test that the default follow_redirects=True allows following redirects
        respx_mock.post("/redirect").mock(
            return_value=httpx.Response(302, headers={"Location": f"{base_url}/redirected"})
        )
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_follow_redirects_disabled(self, respx_mock: MockRouter, async_client: AsyncXTwitterScraper) -> None:
        # Test that follow_redirects=False prevents following redirects
        respx_mock.post("/redirect").mock(
            return_value=httpx.Response(302, headers={"Location": f"{base_url}/redirected"})
        )
