...
from ...types.x import dm_update_params, dm_retrieve_history_params
...
from ...types.x.dm_update_response import DmUpdateResponse
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                dm_update_params.DmUpdateParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=DmUpdateResponse,
        )
